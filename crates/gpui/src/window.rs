...
impl Window {
    ...
    /// Paint a DirectX texture into the scene for the next frame at the current z-index.
    ///
    /// This method should only be called as part of the paint phase of element drawing.
    #[cfg(target_os = "windows")]
    pub(crate) fn paint_external_texture(
...
mod tests {
    ...
    use crate::{
        AnyWindowHandle, AppContext as _, Bounds, Context, Corners, DispatchPhase, DragMoveEvent, Empty,
        ...
        LongPressEvent, MAX_WINDOW_ZOOM, MIN_WINDOW_ZOOM, Modifiers, MouseButton, MouseDownEvent, MouseMoveEvent, ParentElement, Pixels,
        PlatformInput, Point, Render, RequestFrameOptions, ScaledPixels, StatefulInteractiveElement as _, Styled,
        TestAppContext, TouchDragEvent, TouchEvent, TouchId, TouchPhase, VisualTestContext, Window, WindowAppearance,
